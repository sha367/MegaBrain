...
#define CONFIGURE_ARGS " '--prefix=/Applications/Postgres.app/Contents/Versions/17' '--with-includes=/Applications/Postgres.app/Contents/Versions/17/include' '--with-libraries=/Applications/Postgres.app/Contents/Versions/17/lib' '--with-ssl=openssl' '--with-bonjour' '--with-libxml' '--with-libxslt' '--with-python' '--with-readline' '--with-uuid=e2fs' '--with-extra-version= (Postgres.app)' '--with-lz4' '--with-zstd' 'CFLAGS= -Os -mmacosx-version-min=10.13 -arch arm64 -arch x86_64' 'CXXFLAGS= -Os -mmacosx-version-min=10.13 -arch arm64 -arch x86_64' 'PKG_CONFIG_LIBDIR=/Applications/Postgres.app/Contents/Versions/17/lib/pkgconfig' 'ICU_CFLAGS=-I/Applications/Postgres.app/Contents/Versions/17/share/icu' 'ICU_LIBS=-licui18n -licuuc' 'PYTHON=/Library/Frameworks/Python.framework/Versions/3.13/bin/python3'"
...
#define PACKAGE_STRING "PostgreSQL 17.1"
...
#define PG_VERSION "17.1 (Postgres.app)"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 170001

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 17.1 (Postgres.app) on aarch64-apple-darwin23.6.0, compiled by Apple clang version 15.0.0 (clang-1500.3.9.4), 64-bit"
